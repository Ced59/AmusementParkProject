...
describe('TechnicalPagesPageComponent', (): void => {
  it('loads the public list through the technical-pages port', (): void => {
    ...
    const apiPort: MockedObject<PublicTechnicalPagesApiServicePort> = {
      getAllPublicPages: vi
        .fn()
        .mockName('PublicTechnicalPagesApiServicePort.getAllPublicPages'),
    } as unknown as MockedObject<PublicTechnicalPagesApiServicePort>;
    apiPort.getAllPublicPages.mockReturnValue(of([page]));
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        },
        {
          provide: SeoService,
          useValue: {
            applyRouteDefaults: vi
              .fn()
              .mockName('SeoService.applyRouteDefaults'),
          },
        },
      ],
    ...
    const fixture: ComponentFixture<TechnicalPagesPageComponent> =
      TestBed.createComponent(TechnicalPagesPageComponent);
