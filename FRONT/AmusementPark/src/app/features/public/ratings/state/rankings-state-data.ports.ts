...
import { RatingRankingsPage, RatingTargetType } from '@app/models/ratings/rating.models';
import { RatingsApiService } from '@data-access/ratings/ratings-api.service';
import { AnonymousHttpOptions } from '@core/http/auth/anonymous-http-options';

export interface RankingsRatingsPort {
  getRankings(page: number, size: number, targetType: RatingTargetType | null, category: string | null, options?: AnonymousHttpOptions): Observable<RatingRankingsPage>;
}
