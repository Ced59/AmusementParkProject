import { ParkImagesViewComponent } from './park-images-view.component';

describe('ParkImagesViewComponent', () => {
  it('keeps long park names inside the mobile hero', () => {
    const styles: string = (
      ParkImagesViewComponent as unknown as { ɵcmp: { styles: string[] } }
    ).ɵcmp.styles.join('\n');
