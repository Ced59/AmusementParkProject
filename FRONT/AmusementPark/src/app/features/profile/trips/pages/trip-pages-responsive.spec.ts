...
import { TripPassportTransitionPageComponent } from './trip-passport-transition-page/trip-passport-transition-page.component';
...
describe('Trip planning responsive contract', () => {
  ...
  it('keeps the group compass, counts and decision controls inside 320px phones', () => {
    const styles: string = (
      TripPreferenceSummaryPageComponent as unknown as { ɵcmp: { styles: string[] } }
    ).ɵcmp.styles.join('\n');
  ...
  it('keeps the activity timeline and long member names inside 320px phones', () => {
    const styles: string = (
      TripActivityPageComponent as unknown as { ɵcmp: { styles: string[] } }
    ).ɵcmp.styles.join('\n');
  ...
  it('keeps passport attraction cards and confirmation controls inside 320px phones', () => {
    const styles: string = (
      TripPassportTransitionPageComponent as unknown as { ɵcmp: { styles: string[] } }
    ).ɵcmp.styles.join('\n');
