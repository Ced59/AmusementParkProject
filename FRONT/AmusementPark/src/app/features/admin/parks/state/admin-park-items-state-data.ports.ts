...
export interface AdminParkItemsStateParkItemsApiServicePort extends Pick<ParkItemsApiService, 'getParkItemsPaginated' | 'updateParkItemsBulkAdministration' | 'updateParkItemsBulkFields'> {
}
