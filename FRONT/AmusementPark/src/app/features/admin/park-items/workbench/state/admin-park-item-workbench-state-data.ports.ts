...
export interface AdminParkItemWorkbenchStateParkItemsApiServicePort extends Pick<ParkItemsApiService, 'createParkItem' | 'getParkItemById' | 'getParkItemsPaginated' | 'updateParkItemsBulkAdministration'> {
}
