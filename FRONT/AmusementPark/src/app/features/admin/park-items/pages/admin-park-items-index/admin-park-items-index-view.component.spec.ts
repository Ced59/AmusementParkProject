...
describe('AdminParkItemsIndexViewComponent', () => {
  it('enables local search on the park filter without changing the other filters', async () => {
    ...
    const fixture: ComponentFixture<AdminParkItemsIndexViewComponent> =
      TestBed.createComponent(AdminParkItemsIndexViewComponent);
    ...
    expect(parkSelect.filter).toBe(true);
    const filterInput: HTMLInputElement = fixture.debugElement.query(
      By.css('.p-select-filter'),
    ).nativeElement;
    const nativeSelect: HTMLSelectElement = fixture.debugElement.query(
      By.css('.p-select-native'),
    ).nativeElement;
