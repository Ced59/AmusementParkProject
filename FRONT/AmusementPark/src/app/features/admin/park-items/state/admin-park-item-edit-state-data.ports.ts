...
export interface AdminParkItemEditStateParkItemsApiServicePort extends Pick<ParkItemsApiService, 'createParkItem' | 'getParkItemById' | 'getParkItemSiblingNavigation' | 'updateParkItem'> {
}
