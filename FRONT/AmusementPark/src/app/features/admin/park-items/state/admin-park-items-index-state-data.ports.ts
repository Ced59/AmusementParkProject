...
export interface AdminParkItemsIndexStateParkItemsApiServicePort extends Pick<ParkItemsApiService, 'getParkItemsPaginated' | 'updateParkItemsBulkAdministration'> {
}
