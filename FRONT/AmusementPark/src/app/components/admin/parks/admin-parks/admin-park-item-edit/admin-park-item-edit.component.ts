...
export class AdminParkItemEditComponent implements OnInit, OnDestroy {
  ...
  private patchAttractionDetails(details: AttractionDetails | null): void {
    this.form.get('attractionDetails')?.patchValue({
      ...
      isLaunched: details?.isLaunched ?? false,
  ...
  private buildAttractionDetails(raw: any): AttractionDetails | null {
    const details: AttractionDetails = {
      ...
      externalSource: this.toNullableText(raw?.externalSource),
      externalId: this.toNullableText(raw?.externalId),
      sourceUrl: this.toNullableText(raw?.sourceUrl),
      status: this.toNullableText(raw?.status),
      materialType: this.toNullableText(raw?.materialType),
      seatingType: this.toNullableText(raw?.seatingType),
      launchType: this.toNullableText(raw?.launchType),
      restraintType: this.toNullableText(raw?.restraintType),
      isLaunched: raw?.isLaunched ?? false,
      openingDateText: this.toNullableText(raw?.openingDateText),
      closingDateText: this.toNullableText(raw?.closingDateText),
      ...
      heightInFeet: this.toNullableNumber(raw?.heightInFeet),
      heightInMeters: this.toNullableNumber(raw?.heightInMeters),
      lengthInFeet: this.toNullableNumber(raw?.lengthInFeet),
      lengthInMeters: this.toNullableNumber(raw?.lengthInMeters),
      speedInMph: this.toNullableNumber(raw?.speedInMph),
