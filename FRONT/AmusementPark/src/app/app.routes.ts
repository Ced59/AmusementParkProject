    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'park/:id/:slug/item/:itemId/:itemSlug/comments', loadComponent: () => import('./features/public/comments/pages/comments-page.component').then((m) => m.CommentsPageComponent) },
