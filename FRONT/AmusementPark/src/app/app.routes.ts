    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'park/:id/:slug/video/s/:videoId/:videoSlug', loadComponent: () => import('./features/public/parks/pages/park-video-page.component').then((m) => m.ParkVideoPageComponent) },
          { path: 'park/:id/:slug/video/:videoId/:videoSlug', loadComponent: () => import('./features/public/parks/pages/park-video-page.component').then((m) => m.ParkVideoPageComponent) },
          ...
          { path: 'park/:id/:slug/item/:itemId/:itemSlug/video/s/:videoId/:videoSlug', loadComponent: () => import('./features/public/park-items/pages/park-item-video-page.component').then((m) => m.ParkItemVideoPageComponent) },
          { path: 'park/:id/:slug/item/:itemId/:itemSlug/video/:videoId/:videoSlug', loadComponent: () => import('./features/public/park-items/pages/park-item-video-page.component').then((m) => m.ParkItemVideoPageComponent) },
