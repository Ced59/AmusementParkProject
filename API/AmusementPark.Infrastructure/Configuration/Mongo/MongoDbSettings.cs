...
public sealed class MongoDbSettings
{
    ...
    public string NotificationDeliveryAttemptsCollectionName { get; set; } = "notification-delivery-attempts";
    ...
    public string StandaloneAttractionsCollectionName { get; set; } = "standaloneAttractions";
    ...
    public string SocialPublicationsCollectionName { get; set; } = "socialPublications";
    ...
    public string ProfileComparisonInvitationsCollectionName { get; set; } =
    ...
    public string TripAuditOutboxCollectionName { get; set; } = "trip-audit-outbox";
    ...
    public string GlobalRatingSuggestionPreferencesCollectionName { get; set; } =
        "global-rating-suggestion-preferences";

    public string GlobalRatingSuggestionInteractionsCollectionName { get; set; } =
