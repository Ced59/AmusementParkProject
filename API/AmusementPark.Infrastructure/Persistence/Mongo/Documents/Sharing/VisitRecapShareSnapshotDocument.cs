...
public sealed class VisitRecapShareSnapshotDocument : MongoDocumentBase
{
    ...
    [BsonElement("content")]
    public VisitRecapShareContentDocument Content { get; set; } = new VisitRecapShareContentDocument();
}
