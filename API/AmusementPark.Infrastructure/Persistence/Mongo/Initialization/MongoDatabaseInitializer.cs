...
private readonly IMongoDatabase database;
    ...
    public async Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        await this.EnsureCollectionExistsAsync(
            ...
            cancellationToken);
        IMongoCollection<TripNotificationSubscriptionDocument> tripNotificationSubscriptions =
            this.database.GetCollection<TripNotificationSubscriptionDocument>(
                this.settings.TripNotificationSubscriptionsCollectionName);
        await tripNotificationSubscriptions.Indexes.CreateManyAsync(
        ...
        await this.EnsureCollectionExistsAsync(this.settings.HistoricalReviewEventsCollectionName, cancellationToken);
...
private async Task InitializeParkDataEditorAccessTokensIndexesAsync(CancellationToken cancellationToken)
    ...
    private async Task InitializeHistoricalPersistenceIndexesAsync(CancellationToken cancellationToken)
    {
        ...
        IMongoCollection<HistoricalReviewEventDocument> reviewEvents = this.database.GetCollection<HistoricalReviewEventDocument>(
            this.settings.HistoricalReviewEventsCollectionName);
        ...
        await sources.Indexes.CreateManyAsync(
            ...
            cancellationToken);
        await reviewEvents.Indexes.CreateManyAsync(
