...
internal sealed class GetPublicHomeStatsQueryHandlerTestsFakeParkItemRepository : IParkItemRepository
{
    ...
    {
        return this.CountByCategoryAsync(category, includeHidden, cancellationToken);
    }
