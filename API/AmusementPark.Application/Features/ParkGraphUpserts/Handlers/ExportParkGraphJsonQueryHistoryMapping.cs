...
public sealed partial class ExportParkGraphJsonQueryHandler
{
    ...
    private static ParkGraphExportHistoryEvent MapHistoryEvent(HistoryEvent historyEvent)
    {
        ...
        return new ParkGraphExportHistoryEvent
        {
            ...
            ParkId = isParkItemEvent ? historyEvent.ParkId : historyEvent.ParkId ?? historyEvent.OwnerId,
            ParkItemId = isParkItemEvent ? historyEvent.ParkItemId ?? historyEvent.OwnerId : historyEvent.ParkItemId,
            ItemKey = parkItemKey,
