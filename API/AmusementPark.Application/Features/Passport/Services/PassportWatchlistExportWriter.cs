...
internal static class PassportWatchlistExportWriter
{
        ...
        PassportExportReferenceMap references)
    {
        ...
        PassportShareLifecycleExportWriter.WriteCsvRow(writer, new[]
        {
            ...
            "evidenceStatus", "evidenceConfidence", "previousValue", "newValue", "sourceType",
        ...
        foreach (UserNotification notification in request.WatchlistLifecycle.Notifications)
        {
            ...
            PassportShareLifecycleExportWriter.WriteCsvRow(writer, new[]
            {
                ...
                notification.Language, Integer(notification.SourceRevision), factualEvent?.Status.ToString(),
                factualEvent?.Confidence.ToString(), FactValueText(factualEvent?.PreviousValue),
                FactValueText(factualEvent?.NewValue), factualEvent?.Source.Type.ToString(),
                factualEvent?.Source.PublisherName, factualEvent?.Source.Title, factualEvent?.Source.Url,
                NullableTimestamp(factualEvent?.Source.PublishedAtUtc),
                NullableTimestamp(factualEvent?.VerifiedAtUtc),
