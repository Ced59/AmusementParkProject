...
public sealed record UpdateAttractionManufacturerCommand(string Id, AttractionManufacturer AttractionManufacturer) : ICommand<ApplicationResult<AttractionManufacturerResult>>;
