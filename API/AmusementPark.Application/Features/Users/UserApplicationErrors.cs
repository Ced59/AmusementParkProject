...
internal static class UserApplicationErrors
{
    ...
    public static ApplicationError InvalidPreferredLanguage() => ApplicationError.Validation("user.preferred-language.invalid", "The preferred language is not supported.");
