...
public sealed class UpdateParkFitGroupProfileCommandHandler
        ...
        ApplicationResult<ParkFitGroupProfileResult>>
{
    ...
    public UpdateParkFitGroupProfileCommandHandler(ParkFitGroupProfileLifecycleService service)
    {
        this.service = service ?? throw new ArgumentNullException(nameof(service));
    }

    public Task<ApplicationResult<ParkFitGroupProfileResult>> HandleAsync(
        UpdateParkFitGroupProfileCommand command,
