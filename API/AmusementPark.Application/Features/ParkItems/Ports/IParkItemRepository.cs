...
public interface IParkItemRepository
{
    ...
    Task<IReadOnlyCollection<ParkItem>> GetByParkIdsAsync(IReadOnlyCollection<string> parkIds, bool includeHidden, ClosedEntityFilter closedFilter, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyCollection<ParkItem>> GetByManufacturerIdAsync(string manufacturerId, bool includeHidden, CancellationToken cancellationToken);
