...
public sealed class RotateShareIdCommandHandler
    : ICommandHandler<RotateShareIdCommand, ApplicationResult<SharePublicationSettingsResult>>
{
    private readonly SharePublicationLifecycleService lifecycleService;

    public RotateShareIdCommandHandler(SharePublicationLifecycleService lifecycleService)
    {
        this.lifecycleService = lifecycleService;
    }

    public Task<ApplicationResult<SharePublicationSettingsResult>> HandleAsync(
        RotateShareIdCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        return this.lifecycleService.RotateAsync(
            command.UserId,
