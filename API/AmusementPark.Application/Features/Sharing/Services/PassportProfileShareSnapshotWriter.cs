...
public sealed class PassportProfileShareSnapshotWriter : ISharePublicationSnapshotWriter
{
    private readonly IPassportProfileSharePreviewBuilder previewBuilder;
    private readonly IPassportProfileShareSnapshotRepository snapshotRepository;
    private readonly TimeProvider timeProvider;

    public PassportProfileShareSnapshotWriter(
        IPassportProfileSharePreviewBuilder previewBuilder,
        IPassportProfileShareSnapshotRepository snapshotRepository,
        TimeProvider? timeProvider = null)
    {
        this.previewBuilder = previewBuilder ?? throw new ArgumentNullException(nameof(previewBuilder));
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!string.IsNullOrWhiteSpace(request.SourceId) || request.PassportProfile is null)
        {
