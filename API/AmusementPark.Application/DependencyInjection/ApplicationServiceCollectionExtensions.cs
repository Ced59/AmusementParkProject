...
public static class ApplicationServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<TripAdmissionService>();
        ...
        services.AddSingleton<TripProgramEvidenceBuilder>();
        services.AddSingleton<TripProgramAttractionFactBuilder>();
        ...
        services.AddScoped<TripCandidateMutationService>();
        ...
        services.AddScoped<RatingRankingSnapshotBuilder>();
        services.AddScoped<IRatingRankingSnapshotBuilder>(provider =>
            provider.GetRequiredService<RatingRankingSnapshotBuilder>());
        services.AddScoped<IRatingRankingPolicyEvaluationBuilder>(provider =>
            provider.GetRequiredService<RatingRankingSnapshotBuilder>());
        services.AddScoped<RatingRankingAdministrationDashboardReader>();
        services.AddScoped<RatingRankingPolicyImpactPreviewer>();
        services.AddScoped<RatingRankingRebuildRequester>();
        ...
        services.AddScoped<VisitRecapSharePublicationSource>();
        services.AddScoped<ISharePublicationSourceDescriptor>(provider =>
            provider.GetRequiredService<VisitRecapSharePublicationSource>());
        services.AddScoped<IVisitRecapShareSourceVersionProvider>(provider =>
            provider.GetRequiredService<VisitRecapSharePublicationSource>());
        services.AddScoped<VisitRecapSharePreviewBuilder>();
        services.AddScoped<IVisitRecapSharePreviewBuilder>(provider =>
        ...
        services.AddScoped<ProfileComparisonReader>();
        services.AddScoped<ProfileComparisonLifecycleService>();
        services.AddScoped<ShareModerationComparisonTargetExecutor>();
        services.AddScoped<ShareModerationDecisionExecutor>();
        services.AddScoped<ShareModerationPublicationTargetExecutor>();
        services.AddScoped<ShareModerationDecisionScheduler>();
        services.AddScoped<ShareModerationService>();
        services.AddScoped<SharePublicationCacheInvalidationScheduler>();
        services.AddScoped<SharePublicationSourceCacheInvalidator>();
        services.AddDurableBackgroundJobHandler<ShareModerationDecisionJobHandler>();
