...
public static class UseCaseCatalog
{
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> ByFeature { get; } =
        new Dictionary<string, IReadOnlyList<string>>
        {
            ...
            ["StandaloneAttractions"] = new[] { "GetStandaloneAttractionsPage", "GetStandaloneAttractionById", "CreateStandaloneAttraction", "UpdateStandaloneAttraction", "UpdateStandaloneAttractionsBulkAdministration", "MigrateParkToStandaloneAttraction" },
