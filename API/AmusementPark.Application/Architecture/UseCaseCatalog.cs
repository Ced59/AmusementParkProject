...
public static class UseCaseCatalog
{
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> ByFeature { get; } =
        new Dictionary<string, IReadOnlyList<string>>
        {
            ...
            ["Parks"] = new[] { "CreatePark", "GetParkById", "GetParksPage", "GetVisibleParkMapPoints", "SearchParksByName", "SearchParksByLocation", "CalculateParkDistances", "GetNearestParks", "UpdatePark", "UpdateParkVisibility" },
