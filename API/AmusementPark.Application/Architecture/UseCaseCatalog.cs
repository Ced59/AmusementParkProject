...
public static class UseCaseCatalog
{
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> ByFeature { get; } =
        new Dictionary<string, IReadOnlyList<string>>
        {
            ...
            ["ParkItems"] = new[] { "GetParkItemsByParkId", "GetParkItemsPage", "GetParkItemById", "GetParkItemSiblingNavigation", "GetRelatedParkItems", "CreateParkItem", "UpdateParkItem", "DeleteParkItem", "UpdateParkItemsBulkAdministration", "UpdateParkItemsBulkFields", "PreviewParkItemsBulkCreate", "ApplyParkItemsBulkCreate" },
