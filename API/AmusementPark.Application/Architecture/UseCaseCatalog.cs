...
public static class UseCaseCatalog
{
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> ByFeature { get; } =
        new Dictionary<string, IReadOnlyList<string>>
        {
            ...
            ["ParkItems"] = new[] { "GetParkItemsByParkId", "GetParkItemsPage", "GetParkItemById", "CreateParkItem", "UpdateParkItem", "DeleteParkItem", "UpdateParkItemsBulkAdministration", "UpdateParkItemsBulkFields" },
