...
internal static class ParkItemsHttpMappers
{
    ...
    {
        return Enum.TryParse(value.ToString(), out AttractionAccessConditionSourceKind parsed)
            ? parsed
    ...
    {
        return Enum.TryParse(value.ToString(), out AttractionAccessConditionSourceKindDto parsed)
            ? parsed
            : AttractionAccessConditionSourceKindDto.Unknown;
    }

    private static AttractionAccessConditionConfidence ToDomain(this AttractionAccessConditionConfidenceDto value)
    {
        return Enum.TryParse(value.ToString(), out AttractionAccessConditionConfidence parsed)
            ? parsed
    ...
    {
        return Enum.TryParse(value.ToString(), out AttractionAccessConditionConfidenceDto parsed)
            ? parsed
            : AttractionAccessConditionConfidenceDto.Unknown;
    }

    private static AttractionAccessConditionScope ToDomain(this AttractionAccessConditionScopeDto value)
    {
        return Enum.TryParse(value.ToString(), out AttractionAccessConditionScope parsed)
            ? parsed
    ...
    {
        return Enum.TryParse(value.ToString(), out AttractionAccessConditionScopeDto parsed)
            ? parsed
            : AttractionAccessConditionScopeDto.Attraction;
    }
}
