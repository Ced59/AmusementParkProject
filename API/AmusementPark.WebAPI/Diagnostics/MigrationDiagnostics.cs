    ...
    public static object CreateHealthPayload()
    {
        return new
        {
            ...
            migration = new
            {
                ...
                status = "in-progress",
                currentPhase = "P06",
                currentPhaseTitle = "Back — vraie refonte du refresh token",
                nextPhase = "P07",
                referenceDocument = "API/ARCHITECTURE/P06-REFRESH-TOKEN-REWORK.md",
                principles = new[]
                {
                ...
                phases = new[]
                {
                    ...
                    new { code = "P06", title = "Back — vraie refonte du refresh token", state = "current" },
