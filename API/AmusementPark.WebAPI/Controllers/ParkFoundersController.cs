...
public sealed class ParkFoundersController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(IEnumerable<ParkFounderDto>), StatusCodes.Status200OK)]
    public async Task<IActionResult> GetAllAsync(CancellationToken cancellationToken = default)
    {
        ...
        List<ParkFounderDto> response = result.Value.Select(static value => value.ToHttp()).ToList();
