...
public sealed class RatingAggregateSourceReaderTests
{
    ...
    public void BuildPipeline_ShouldDeduplicateContributorsAndRetainObservationTotals()
    {
        ...
        Assert.Equal("$userId", contributorGroup["_id"]["userId"].AsString);
    ...
    [Fact]
    public void IsProjectionValid_WhenDerivedScoreDiverges_ShouldReturnFalse()
    {
        ...
        Assert.False(RatingAggregateSourceReader.IsProjectionValid(aggregate, source));
    }

    [Fact]
    public void IsProjectionValid_WhenSourceAndProjectionAreEmpty_ShouldReturnTrue()
    {
        RatingAggregate aggregate = new RatingAggregate
        {
        ...
        Assert.True(RatingAggregateSourceReader.IsProjectionValid(aggregate, source: null));
    }
}
