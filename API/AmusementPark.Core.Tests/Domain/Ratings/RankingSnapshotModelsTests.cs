...
public sealed class RankingSnapshotModelsTests
{
    ...
    public void Entry_WhenSingleCategoryExceptionIsPolicyProduced_ShouldPreserveItsProof()
    {
        ...
        Assert.Equal(1, entry.Evidence.PublicItemCategoryCount);
    }

    [Fact]
    public void Entry_WhenSingleCategoryExceptionContradictsPublicCategoryFacts_ShouldRejectIt()
    {
        RankingEvidence forgedEvidence = new RankingEvidence(
            RankingEvidenceLevel.Eligible,
            true,
