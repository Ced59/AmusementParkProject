...
Quatre-vingt-dix-sept scénarios FIT-04 couvrent notamment :
...
- portée de configuration conservée comme inconnue même lorsque sa preuve est aussi inutilisable ;
...
- chemin seul physiquement impossible ignoré pour déterminer si l'accompagnement est inévitable ;
- âge d'accompagnateur mal rattaché conservé comme incertitude du chemin accompagné ;
- comparaison tolérante des seuils de taille indépendante de leur ordre ;
...
- conservation de toutes les valeurs en conflit et des bornes indépendantes ;
- conflit d'une voie accompagnée conservé comme incertitude sans faux rejet sur la voie seule ;
...
- voie accompagnée fiable conservée malgré une règle seule périmée, sans masquer l'incertitude si l'accompagnement échoue ;
...
- départage ordinal des codes langue de résumés qui ne diffèrent que par la casse ;
