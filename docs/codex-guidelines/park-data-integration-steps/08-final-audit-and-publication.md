...
1. Avant toute mutation de visibilité, contrôler l’état global des opérations puis obtenir un nouvel export complet frais du parc. Le rapprocher de l’export audité et des réponses des éventuelles corrections ciblées, puis rejouer tous les contrôles bloquants sur cet état réellement en ligne. Toute différence inexpliquée suspend la publication jusqu’à une correction ciblée et une nouvelle validation. Cet export appartient au flux de publication séparément autorisé et ne remet pas en cause l’unique export complet obligatoire du parcours de complétion 0 à 8.
