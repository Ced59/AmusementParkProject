...
- Rechercher le logo officiel actuel et viser au moins cinq photographies générales distinctes du parc, hors logo, qui montrent réellement le site dans son ensemble ou plusieurs de ses espaces identifiables. Un gros plan d’attraction ne compte pas comme vue générale.
- Pour chaque parkItem important, actuel ou historique, viser au moins trois photographies distinctes et fidèles, avec des cadrages ou contextes réellement complémentaires. Rechercher aussi au moins une image fidèle pour toute autre attraction actuelle, annoncée, en construction ou définitivement fermée, ainsi qu’une image contextualisée pour chaque jalon et article historique.
- Les seuils de cinq et trois images sont la norme lorsque les sources le permettent. Une source secondaire est autorisée après vérification visuelle si le sujet est certain, le crédit est possible et aucun watermark tiers n’est présent. Un petit parc ou un parkItem insuffisamment documenté peut rester sous le seuil seulement après une recherche réelle consignée avec le nombre atteint, les familles de sources consultées et la raison factuelle ; ne jamais compléter le quota avec une image générique, trompeuse ou quasi dupliquée.
