...
- 41 parcs atteignent le niveau `Excellent` : 39 satisfont la condition de sortie, avec un score strictement supérieur à 95, et 2 restent dans le backlog à 95.
- **123 parcs publiés remplissent le critère d’entrée, avec un score inférieur ou égal à 95** : 58 au niveau `Publishable`, 63 au niveau `Good` et 2 au niveau `Excellent`.
