...
- **124 parcs publiés avaient un score inférieur ou égal à 95 lors du rafraîchissement de référence** ; après 95 retraits validés et les 2 exceptions explicites enregistrées ci-dessous, le backlog actif contient **27 parcs** : 0 au niveau `Publishable`, 25 au niveau `Good` et 2 au niveau `Excellent`.
