...
- **117 parcs publiés remplissent le critère d’entrée, avec un score inférieur ou égal à 95** : 51 au niveau `Publishable`, 64 au niveau `Good` et 2 au niveau `Excellent`.
...
## Priorité 1 — niveau `Publishable` (51)
...
| 78 | `Publishable` | Bad Kleinkirchheimer Bergbahnen | AT | `Operating` | `International` | 76/97 | `fbc42394-2f76-4526-826b-f877d1182155` |
...
| 79 | `Publishable` | Akasya Luna Park | TR | `Operating` | `Regional` | 70/89 | `9f6700d9-d6e5-4c08-947d-d17b39b3fbf4` |
| 79 | `Publishable` | Anjo World | PH | `Operating` | `National` | 74/94 | `518d336a-1f2c-4080-859d-e876b86e7717` |
| 80 | `Publishable` | Adapark Lunapark | TR | `Operating` | `Local` | 74/92 | `5013be42-9fa7-4dcd-a5ff-37f50a5e96ff` |
| 80 | `Publishable` | Adrenalin-Show | UA | `Operating` | `Regional` | 70/88 | `f5878ff8-eadd-4eb6-b83f-8645332b2e88` |
| 80 | `Publishable` | Adventure City | US | `Operating` | `Regional` | 70/88 | `14db2dd8-c4b0-491f-9b10-46855292d96b` |
...
| 80 | `Publishable` | Energylandia | PL | `Operating` | `International` | 79/99 | `30ef201a-088e-4274-8168-1230b91194e9` |
| 80 | `Publishable` | Loos Parc | FR | `Operating` | `Local` | 70/88 | `80b9ed92-b303-4000-a484-66872ee6412f` |
| 80 | `Publishable` | Plopsaland Ardennes | BE | `Operating` | `National` | 79/99 | `b94c7d82-3178-4f56-876b-c944edb8ec1e` |
...
| 81 | `Publishable` | Asia Park | VN | `ClosedDefinitively` | `—` | 78/96 | `2bc6063d-6bd5-491c-926f-416e7d529261` |
| 81 | `Publishable` | Plopsaland Deutschland | DE | `Operating` | `National` | 77/95 | `cbaf293c-0ee9-4eda-b5cf-e8daad53443d` |
| 81 | `Publishable` | Six Flags AstroWorld | US | `ClosedDefinitively` | `—` | 82/101 | `5a221acc-5524-4a20-ba33-51078484309d` |
| 82 | `Publishable` | Adventure Park USA | US | `Operating` | `Regional` | 76/93 | `a457eea1-1444-41ff-b892-2a06b4463e0f` |
...
| 83 | `Publishable` | Cita-Parc | FR | `Operating` | `Regional` | 73/88 | `1d4ec4ab-5f19-4b1b-b4cf-8e240dce3304` |
| 83 | `Publishable` | Labadee | HT | `Operating` | `International` | 91/109 | `6f64d243-7b8f-4495-a731-9faa76c0bb62` |
...
| 84 | `Publishable` | Adventurer's Park Family Entertainment Center | US | `Operating` | `Local` | 75/89 | `6e3e55c1-683c-4ad9-acd8-f9cfaae2354f` |
...
| 94 | `Good` | Al-Qidah Park | DZ | `Operating` | `Regional` | 95/101 | `3212fabf-2a98-4af0-9111-917461fccbb5` |
...
## Blocages après reprise

| Parc | Dernier audit | Score courant / projeté | Blocage factuel |
| --- | --- | --- | --- |
| Al-Qidah Park | 2026-08-13 17:22 Europe/Paris | 94 (95/101) / 94 (95/101) | Les sources disponibles n’identifient ni le constructeur des attractions mécaniques ni une condition d’accès fiable. Le seuil strict de 96 n’est pas atteint ; Facebook n’a pas été lancé. |
