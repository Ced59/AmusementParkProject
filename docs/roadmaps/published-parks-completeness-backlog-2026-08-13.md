...
- 49 parcs atteignent le niveau `Excellent` : 47 satisfont la condition de sortie, avec un score strictement supérieur à 95, et 2 restent dans le backlog à 95.
- **116 parcs publiés ont un score inférieur ou égal à 95** ; après l’exception explicite enregistrée ci-dessous et les retraits validés, le backlog actif contient **69 parcs** : 4 au niveau `Publishable`, 63 au niveau `Good` et 2 au niveau `Excellent`.
...
## Priorité 1 — niveau `Publishable` (4)
