...

{
  ...
  write_line FRONT_MEMORY_LIMIT "$(value_or_default FRONT_MEMORY_LIMIT '1536m')"
  ...
  write_line SSR_SEO_STATIC_SNAPSHOT_ENABLED "$(value_or_default SSR_SEO_STATIC_SNAPSHOT_ENABLED 'true')"
  write_line SSR_SEO_STATIC_SNAPSHOT_REFRESH_INTERVAL_SECONDS "$(value_or_default SSR_SEO_STATIC_SNAPSHOT_REFRESH_INTERVAL_SECONDS '21600')"
  write_line SSR_SEO_STATIC_SNAPSHOT_REFRESH_DEBOUNCE_MILLISECONDS "$(value_or_default SSR_SEO_STATIC_SNAPSHOT_REFRESH_DEBOUNCE_MILLISECONDS '30000')"
  write_line SSR_SEO_STATIC_SNAPSHOT_FETCH_CONCURRENCY "$(value_or_default SSR_SEO_STATIC_SNAPSHOT_FETCH_CONCURRENCY '2')"
  write_line SSR_SEO_STATIC_SNAPSHOT_FETCH_TIMEOUT_SECONDS "$(value_or_default SSR_SEO_STATIC_SNAPSHOT_FETCH_TIMEOUT_SECONDS '60')"
  write_line SSR_SEO_STATIC_SNAPSHOT_MAX_DOCUMENT_BYTES "$(value_or_default SSR_SEO_STATIC_SNAPSHOT_MAX_DOCUMENT_BYTES '33554432')"
  ...
  write_line SSR_RENDER_SEO_READY_RETRY_COUNT "$(value_or_default SSR_RENDER_SEO_READY_RETRY_COUNT '3')"
  write_line SSR_RENDER_SEO_READY_RETRY_DELAY_MILLISECONDS "$(value_or_default SSR_RENDER_SEO_READY_RETRY_DELAY_MILLISECONDS '500')"
  ...
  write_line SSR_DISK_PAGE_CACHE_STATS_INTERVAL_SECONDS "$(value_or_default SSR_DISK_PAGE_CACHE_STATS_INTERVAL_SECONDS '300')"
  write_line SSR_DISK_PAGE_CACHE_STATS_BATCH_SIZE "$(value_or_default SSR_DISK_PAGE_CACHE_STATS_BATCH_SIZE '100')"
  write_line SSR_DISK_PAGE_CACHE_STATS_YIELD_MILLISECONDS "$(value_or_default SSR_DISK_PAGE_CACHE_STATS_YIELD_MILLISECONDS '0')"
  write_line SSR_TECHNICAL_STATS_PERSISTENCE_ENABLED "$(value_or_default SSR_TECHNICAL_STATS_PERSISTENCE_ENABLED 'true')"
  write_line SSR_TECHNICAL_STATS_RETENTION_DAYS "$(value_or_default SSR_TECHNICAL_STATS_RETENTION_DAYS '100')"
  ...
  write_line SSR_WARMUP_BACKGROUND "$(value_or_default SSR_WARMUP_BACKGROUND 'false')"
  ...
  write_line SSR_WARMUP_BOT_VALIDATION_MAX_URLS "$(value_or_default SSR_WARMUP_BOT_VALIDATION_MAX_URLS '250')"
  ...
  write_line TRIP_FINGERPRINT_CURRENT_VERSION "$(value_or_default TRIP_FINGERPRINT_CURRENT_VERSION 'v1')"
  write_line TRIP_FINGERPRINT_CURRENT_KEY "${TRIP_FINGERPRINT_CURRENT_KEY:?TRIP_FINGERPRINT_CURRENT_KEY is required}"
  write_line TRIP_FINGERPRINT_PREVIOUS_KEYS "$(value_or_default TRIP_FINGERPRINT_PREVIOUS_KEYS '')"
  ...
  write_line SOCIAL_PUBLISHING_FACEBOOK_ENABLED "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_ENABLED 'false')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_API_VERSION "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_API_VERSION 'v24.0')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_PAGE_ID "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_PAGE_ID '')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_PAGE_ACCESS_TOKEN "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_PAGE_ACCESS_TOKEN '')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_PAGE_URL "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_PAGE_URL '')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_REQUEST_TIMEOUT_SECONDS "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_REQUEST_TIMEOUT_SECONDS '30')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_WEBHOOK_ENABLED "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_WEBHOOK_ENABLED 'false')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_APP_SECRET "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_APP_SECRET '')"
  write_line SOCIAL_PUBLISHING_FACEBOOK_WEBHOOK_VERIFY_TOKEN "$(value_or_default SOCIAL_PUBLISHING_FACEBOOK_WEBHOOK_VERIFY_TOKEN '')"
  ...
  write_line DEPLOY_ZERO_DOWNTIME_ENABLED "$(value_or_default DEPLOY_ZERO_DOWNTIME_ENABLED 'true')"
  write_line SHARED_INFRASTRUCTURE_MAINTENANCE "$(value_or_default SHARED_INFRASTRUCTURE_MAINTENANCE 'none')"
