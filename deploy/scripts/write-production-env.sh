...

{
  ...
  write_line SSR_INTERNAL_BASE_URL "$(value_or_default SSR_INTERNAL_BASE_URL 'http://amusementpark-front:4000')"
  ...
  write_line RUN_LEGACY_ENUM_MIGRATIONS "$(value_or_default RUN_LEGACY_ENUM_MIGRATIONS 'true')"
