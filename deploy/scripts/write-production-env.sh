...

{
  ...
  write_line SSR_RENDER_SEO_READY_RETRY_COUNT "$(value_or_default SSR_RENDER_SEO_READY_RETRY_COUNT '1')"
  write_line SSR_RENDER_SEO_READY_RETRY_DELAY_MILLISECONDS "$(value_or_default SSR_RENDER_SEO_READY_RETRY_DELAY_MILLISECONDS '150')"
