...

{
  ...
  write_line SSR_SEO_DOCUMENT_CACHE_SECONDS "$(value_or_default SSR_SEO_DOCUMENT_CACHE_SECONDS '3600')"
  ...
  write_line SSR_RENDER_QUEUE_MAX_ENTRIES "$(value_or_default SSR_RENDER_QUEUE_MAX_ENTRIES '0')"
  write_line SSR_RENDER_QUEUE_WARNING_THRESHOLD "$(value_or_default SSR_RENDER_QUEUE_WARNING_THRESHOLD '1')"
