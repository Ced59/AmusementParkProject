...
- The short completion request authorizes autonomous execution of every applicable step, including research, bounded Preview/Apply lots, refreshed exports, image imports and the final audit. It does not authorize publication, deletion, hiding previously public content, or cleanup of an unknown legacy entity.
